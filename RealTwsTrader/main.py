...
class AutomatedPredictor(ConfigLoader):
    ...
    def _execute_real_trader(self):
        ...
        try:
            ...
            result = subprocess.run(["python", script_path], cwd=self.project_root_path, timeout=60*60)
            ...
            print(f"{self.red_color_code}Timeout: RealTrader.py took more than 60 minutes to execute{self.reset_color_code}")
        except Exception as e:
